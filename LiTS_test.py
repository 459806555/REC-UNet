...
from LiTS_dataset import Dataset

from LiTS_utilities.metrics import dice_coef, batch_iou, mean_iou, iou_score,ppv,iou_score_batch,sensitivity,p_value_test,accuracy,precision,F1_score
import LiTS_utilities.losses as losses
...
def main():
    ...
    val_img_paths = glob('./LiTS_data/test_image/*')
    val_mask_paths = glob('./LiTS_data/test_label/*')
