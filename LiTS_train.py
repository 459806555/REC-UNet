...
from LiTS_utilities.metrics import dice_coef, batch_iou, mean_iou, iou_score
...
def main():
    ...
    img_paths = glob('./LiTS_data/train_image/*')
    mask_paths = glob('./LiTS_data/train_label/*')
    # Data loading code
    train_img_paths, val_img_paths, train_mask_paths, val_mask_paths = \
        train_test_split(img_paths, mask_paths, test_size=0.3)
