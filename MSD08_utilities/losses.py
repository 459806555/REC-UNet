...
class BCEDiceLoss(nn.Module):
    ...
    def forward(self, input, target):
        ...
        return bce + dice
class BCEDiceLoss_3(nn.Module):
    def __init__(self):
        super(BCEDiceLoss_3, self).__init__()
...
class BCESLSLoss(nn.Module):
    ...
    def forward(self, input, target):
        ...
        LLoss1 = SLSIoULoss(input_1,target_1)
        LLoss2 = SLSIoULoss(input_2, target_2)
        LLoss = (LLoss1 + LLoss2) * 0.5
        Loss = bce + LLoss
        return Loss