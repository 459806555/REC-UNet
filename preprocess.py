...
ct_path = r"E:\liver_project\MSD_Task08\Task08_HepaticVessel\data\train_data"
seg_path = r"E:\liver_project\MSD_Task08\Task08_HepaticVessel\data\train_label"
png_path = './png/'

outputImg_path = r"E:\liver_project\MSD_Task08\data\train_image"
outputMask_path = r"E:\liver_project\MSD_Task08\data\train_label"
...
if __name__ == "__main__":
    ...
    for index, file in enumerate(tqdm(os.listdir(ct_path))):
        ...
        #  LiTS 2017  [:, 0:512, 0:512]     MSD_Task08  [:, 32:480, 32:480]
        ...
        if int(np.sum(mask_crop)) != 0:
            for n_slice in range(mask_crop.shape[0]):
                ...
                np.save(maskpath, maskImg)  # (448，448) dtype('uint8')
        else:
            continue
    print("Done！")
